    ...
    case "ZipWith":
      {
        return core.gen(function* () {
          ...
          return memoMap => (0, _Function.pipe)(memoMap.getOrElseMemoize(op.first, firstScope), fiberRuntime.zipWithOptions(memoMap.getOrElseMemoize(op.second, secondScope), op.zipK, {
            concurrent: true
          }));
        });
      }
