...
const make = options => core.withFiberRuntime(fiber => {
  ...
  const idleTimeToLive = options.idleTimeToLive === undefined ? undefined : typeof options.idleTimeToLive === "function" ? (0, _Function.flow)(options.idleTimeToLive, Duration.decode) : (0, _Function.constant)(Duration.decode(options.idleTimeToLive));
