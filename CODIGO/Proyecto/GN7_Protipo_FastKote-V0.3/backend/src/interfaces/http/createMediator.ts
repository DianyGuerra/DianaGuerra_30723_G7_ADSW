...
import { CatalogPackagesHandler } from '../../application/catalog/CatalogPackages.handler.js';
import { InventoryHandler } from '../../application/catalog/Inventory.handler.js';
import { ServicesHandler } from '../../application/catalog/Services.handler.js';
import { PromotionsHandler } from '../../application/catalog/Promotions.handler.js';
...
export function createMediator() {
  ...
  mediator.register('services.manage', new ServicesHandler(catalogRepository));
  mediator.register('promotions.manage', new PromotionsHandler(catalogRepository));
