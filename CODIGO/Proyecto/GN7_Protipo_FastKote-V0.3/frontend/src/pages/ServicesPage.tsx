        ...
        <Modal title="Gestionar contenido de paquete" onClose={() => setSelected(null)}>
          <div className="detail-grid">
            ...
            <div className="small-form">
              ...
              <input type="number" min="1" value={component.quantity} onChange={(e) => setComponent({ ...component, quantity: Math.max(1, Number(e.target.value)) })} />
              <input type="number" step="0.01" min="0" value={component.unitCost} onChange={(e) => setComponent({ ...component, unitCost: Math.max(0, Number(e.target.value)) })} />
